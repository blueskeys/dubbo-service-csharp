 ...
 * @since 3.0.2
 */
public final class IpAddressMatcherUtils {

	private final int         nMaskBits;
	private final InetAddress requiredAddress;


	public static boolean matches(String ipMatcherRule, String ipAddress) {
		return new IpAddressMatcherUtils(ipMatcherRule).matches(ipAddress);
	}
	 ...
	 */
	public IpAddressMatcherUtils(String ipAddress) {
